...
<head>
    <div id="header">
        <img src="images.png">
        <div id="header-text">SIGN ON</div>
    </div>
...
<div id="phpcode">
 ...
 $query="UPDATE crew SET status='signon' WHERE username='$name'";
 ...
 while($row=mysql_fetch_array($res1)){
     echo "SIGNON FROM STATION :{$row['from_station']} ";
     
 }
 while($row=mysql_fetch_array($res2)){
    
    echo "TO STATION: {$row['destination']}";
 }
...
<div id="body">
    ...
    <body>
        ...
        <button id="button-signoff" type="submit" formaction="updateoff.php"><a href="updateoff.php">SIGNOFF</a></button>
        <br>
        <br>
                <button id="back" type="submit" formaction="updateoff.php"><a href="freight.html">GO TO FREIGHT MENU</a></button>
