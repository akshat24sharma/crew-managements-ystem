...
<div id="phpcode">
 ...
 while($row=mysql_fetch_array($res2)){
     echo "SIGNON FROM STATION :{$row['destination']} ";
     
 }
 while($row=mysql_fetch_array($res1)){
    
    echo "TO STATION: {$row['from_station']}";
 }
...
?>
        ...
        <body>
            ...
            <button id="button-signoff" type="submit" formaction="updateoff.php"><a href="updaterest.php">REST</a></button>
